...
# Occlusion
class RssExtOcclusion(BasicScenario):

    def __init__(self, world, rss_params, filename, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True, variant="RSS_Ext_OCCL_a"):
        ...
        super(RssExtOcclusion, self).__init__("RssExtOcclusion",
                                                   ego_vehicles,
                                                   config,
                                                   world,
                                                   debug_mode,
    ...
    def _create_behavior(self):
        ...
        other_0_drive.add_child(KeepVelocity(self.other_actors[0], target_velocity=self._other_actor_target_speed, distance=90))
